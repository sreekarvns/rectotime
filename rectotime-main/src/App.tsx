...
function RouteSmoothScrollController() {
...
function AppContent() {
  ...
  return (
    <div className={`flex h-screen ${isVideoBackground ? 'bg-transparent' : 'bg-white dark:bg-background-dark'}`}>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                {currentView === 'dashboard'
                  ...
                  : currentView === 'integrations'
                  ? 'Connect your apps and wearables'
          ...
          <AnimatePresence mode="wait">
            ...
            {currentView === 'dashboard' && (
              <AnimatedPage key="dashboard">
                <Dashboard goals={goals} tasksCount={tasks.length} onNavigate={setCurrentView} />
              </AnimatedPage>
            )}

            {/* Calendar Views */}
            {currentView === 'calendar' && (
              <AnimatedPage key="calendar">
      ...
      {/* Modals */}
      <OnboardingModal onNavigate={setCurrentView} />
      <AddEventModal
...
/**
 * App wrapper with error boundary, providers, and routing
 */
export default function App() {
  return (
    <ErrorBoundary>
      <BrowserRouter>
        <RouteSmoothScrollController />
        <AuthProvider>
          <ThemeProvider>
            <MusicProvider>
              <Routes>
